...
public class prak7 {
    ...
    public static void daftarFilm(HashMap<String, ArrayList<String>> movieFavourite) {
        ...
        if (judulFilm.isEmpty()) {
            System.out.println("1. Avenger : Endgame ");
            System.out.println("2. Spiderman : Far From Home ");
            System.out.println("3. Venom ");
            System.out.println("4. Thor : Ragnarok ");
        }
    ...
    public static void addFilm(HashMap<String, ArrayList<String>> movieFavourite, Scanner scan2) {
        ...
        durasi = scan2.nextLine();
        System.out.print("Genre:" + " ");
        genre = scan2.nextLine();
        System.out.print("Sinopsis:" + " ");
        sinopsis = scan2.nextLine();
        cast = scan2.nextLine();
