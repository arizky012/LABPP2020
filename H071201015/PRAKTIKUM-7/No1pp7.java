  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      if (op.equals("d")) {
        ...
        System.out.println("Judul    : " + favMov.get(j));
        System.out.println("Rilis    : " + rilis.get(j));
        System.out.println("Durasi   : " + durasi.get(j));
        System.out.println("Genre    : " + genre.get(j));
        System.out.println("Sinposis : " + sinopsis.get(j));
        System.out.println("Cast     : " + cast.get(j));
